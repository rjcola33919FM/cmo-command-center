...
export const FLOWS: Record<FlowKey, Flow> = {
  executive_strategy: {
    ...
    chain: ["cmo-gpt", "marketing-strategy-gpt", "data-visualization-gpt", "marketing-orchestrator-gpt", "cmo-gpt"],
  },
  campaign_performance: {
  ...
  crm_lifecycle: {
    ...
    chain: ["cmo-gpt", "hubspot-crm-gpt", "hubspot-inbound-gpt", "data-visualization-gpt", "marketing-orchestrator-gpt", "cmo-gpt"],
  },
  customer_insight: {
    ...
    chain: ["cmo-gpt", "market-research-gpt", "voice-of-customer-gpt", "marketing-strategy-gpt", "marketing-orchestrator-gpt", "cmo-gpt"],
  },
  competitive_positioning: {
    ...
    chain: ["cmo-gpt", "competitive-strategy-gpt", "marketing-strategy-gpt", "data-visualization-gpt", "marketing-orchestrator-gpt", "cmo-gpt"],
  },
  launch_or_gtm: {
    name: "Launch / GTM",
    ...
    chain: ["cmo-gpt", "marketing-strategy-gpt", "market-research-gpt", "competitive-strategy-gpt", "hubspot-inbound-gpt", "marketing-automation-gpt", "marketing-orchestrator-gpt", "cmo-gpt"],
  },
  dashboard_reporting: {
    ...
    chain: ["cmo-gpt", "data-visualization-gpt", "google-analytics-gpt", "hubspot-crm-gpt", "marketing-orchestrator-gpt", "cmo-gpt"],
  },
};
